...
declare namespace $ {
    class $bun_alh_controls_page extends $bun_alh_page {
        app_page(next?: any): string;
        title(): string;
        with_back(): boolean;
        back(next?: any): any;
        back_hint(): string;
        content(): readonly any[];
        open_start_page(next?: any): any;
        Ways_title(): $mol_view;
        way_title(id: any): string;
        Way_title(id: any): $mol_view;
        way_description(id: any): string;
        Way_description(id: any): $mol_view;
        Way(id: any): $mol_view;
        way_list(): readonly any[];
        Way_list(): $mol_view;
...
declare namespace $.$$ {
    ...
    export class $bun_alh_controls_page extends $.$bun_alh_controls_page {
        open_start_page(): void;
        ways(): Array<ControlWay>;
        way_list(): $mol_view[];
        way_title(idx: number): string;
        way_description(idx: number): string;
    }
    export {};
}
...
declare namespace $ {
    function $bun_alh_game_combine(...elements: $bun_alh_game_ings_nullable): string | undefined;
}

declare namespace $ {
    type $bun_alh_game_element = {
        id: string;
        name: string;
    };
}
...
declare namespace $ {
    const $bun_alh_game_elements: Array<$bun_alh_game_element>;
}
...
declare namespace $ {
    type $bun_alh_game_combine_list = [string | null, string | null];
    class $bun_alh_game extends $mol_object {
        element_list(): Array<$bun_alh_game_element>;
        element(id: string): $bun_alh_game_element | null;
        element_icon(id: string): string;
        element_name(id: string): string;
        element_ids_base(): string[];
        element_ids_known(next?: Array<string>): string[];
...
declare namespace $ {
    class $bun_alh_game_cell_drag extends $mol_drag {
        ...
        transfer(): Record<string, any>;
        Sub(): $$.$bun_alh_game_cell;
        element_id(): string;
        element_name(): string;
        hint(): string;
        element_icon(): string;
        element_size(): number;
        Cell(): $$.$bun_alh_game_cell;
    }
}
...
declare namespace $ {
    class $bun_alh_game_cell_known extends $bun_alh_game_cell_drag {
        ...
        event(): Record<string, any>;
        from_id(): string;
        add_element_to_empty_combine_cell(next?: any): any;
    }
}

declare namespace $.$$ {
    class $bun_alh_game_cell_known extends $.$bun_alh_game_cell_known {
        add_element_to_empty_combine_cell(): void;
    }
}
...
declare namespace $ {
    class $bun_alh_game_cell_combine extends $mol_drop {
        ord(): number;
        combine_list(next?: any): readonly any[];
        adopt(next?: any): any;
        event(): Record<string, any>;
        Sub(): $$.$bun_alh_game_cell_drag;
        transfer_adopt(next?: any): any;
        clear(next?: any): any;
        element_name(): string;
        element_id(next?: any): any;
        element_icon(): string;
        element_size(): number;
        current_dragged(next?: any): any;
        drag_from_data(): any;
        Drag(): $$.$bun_alh_game_cell_drag;
    }
}

declare namespace $ {
    function $bun_array_swap<T>(arr: Readonly<Array<T>>, ind1: number, ind2: number): readonly T[];
}

declare namespace $ {
    function $bun_array_write<T>(arr: Readonly<Array<T>>, index: number, new_el: T): T[];
}
...
declare namespace $.$$ {
    class $bun_alh_game_cell_combine extends $.$bun_alh_game_cell_combine {
        ...
        transfer_adopt(transfer: DataTransfer): string;
        receive(element_id: string): void;
        clear(): void;
    }
}
...
declare namespace $ {
    class $bun_alh_game_page extends $bun_alh_page {
        ...
        current_dragged(next?: any): any;
        combine_list(next?: any): any;
        drag_from(next?: any): any;
        content(): readonly any[];
        open_start_page(next?: any): any;
        open_recipes(next?: any): any;
        ...
        combine_element_icon(id: any): string;
        combine_element_name(id: any): string;
        Cell_combine(id: any): $$.$bun_alh_game_cell_combine;
        cells_combine(): readonly any[];
        result_element_name(): string;
        result_element_icon(): string;
        result_element_useless(): boolean;
        result_element_new(): boolean;
        on_result_click(next?: any): any;
...
declare namespace $.$$ {
    ...
    export class $bun_alh_game_page extends $.$bun_alh_game_page {
        ...
        open_recipes(): void;
        element_ids_known(next?: Array<string>): string[];
        elements(): $bun_alh_game_cell_known[];
        ...
        combine_list(next?: $bun_alh_game_combine_list): $bun_alh_game_combine_list;
        cells_combine(): $bun_alh_game_cell_combine[];
        cell_combine_ord(ord: number): number;
        combine_element_id(ord: number, next?: string | null): string;
        combine_element_name(ord: number): string;
        combine_element_icon(ord: number): string;
        combine_sub(): ($bun_alh_game_cell_combine | $bun_alh_game_cell_result)[];
        element_useless(element_id: string | null | undefined): boolean;
        result_element_id(): string | null;
        result_element_useless(): boolean;
        result_element_new(): boolean;
        result_element_icon(): string;
        result_element_name(): string;
        clear_combine_list(): void;
        know_element(element_id: string): void;
        grab_element(element_id: string): void;
        on_result_click(): void;
    }
    export {};
}
...
declare namespace $ {
    type $bun_alh_game_ings = [string, string];
    type $bun_alh_game_ings_nullable = [string | null, string | null];
    type $bun_alh_game_recipes_type = Record<string, $bun_alh_game_ings>;
    const $bun_alh_game_recipes: $bun_alh_game_recipes_type;
}
...
declare namespace $ {
    class $bun_alh_game_recipes_page extends $bun_alh_page {
        ...
        content(): readonly any[];
        open_game(next?: any): any;
        ing_icon(id: any): string;
        ing_name(id: any): string;
        Ing(id: any): $$.$bun_alh_game_cell;
        Plus_icon(id: any): $mol_icon_plus;
        Ings_plus_icon(id: any): $mol_view;
        ing_rows(id: any): readonly any[];
        Ings(id: any): $mol_view;
        Result_icon(id: any): $mol_icon_arrow_right_bold_outline;
        Recipe_result_icon(id: any): $mol_view;
        Result(id: any): $$.$bun_alh_game_cell_result;
        Recipe(id: any): $mol_view;
        recipe_rows(): readonly any[];
        board_title(): string;
...
declare namespace $.$$ {
    class $bun_alh_game_recipes_page extends $.$bun_alh_game_recipes_page {
        open_game(): void;
        recipe_count_total(): number;
        recipe_count_known(): number;
        board_title(): string;
        board_content(): $mol_view[];
        element_id_no_idx(id: string): string;
        ing_icon(id: string): string;
        ing_name(id: string): string;
        ings(element: string): $bun_alh_game_ings;
        ing_rows_components(element: string): $bun_alh_game_cell[];
        ing_rows(element: string): $mol_view[];
        recipe_rows(): $mol_view[];
    }
}
...
declare namespace $ {
    class $bun_alh_app extends $mol_view {
        ...
        open_controls_page(next?: any): any;
        Controls_button(): $bun_alh_app_menu_button;
        Start_menu(): $mol_view;
        page(next?: any): string;
        element_ids_combined_reversed(): readonly any[];
    }
}

declare namespace $.$$ {
    type Page = 'start' | 'controls' | 'game' | 'recipes';
    export class $bun_alh_app extends $.$bun_alh_app {
        auto(): void;
        on_app_open(): void;
        on_app_close(): void;
        page(next?: Page): Page;
        game(next?: $bun_alh_game | null): $bun_alh_game;
        element_ids_combined_reversed(): string[];
        play(): void;
        open_controls_page(): void;
        sub(): $mol_view[];
    }
    export {};
}
